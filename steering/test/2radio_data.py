...
# %%
data_dir = (
    "/scratch/users/rfuchs/packages/aim-resolve/steering/data/runs/files/test512_10.pkl"
)
...
# %%
obs_new.save(
    "/scratch/users/rfuchs/packages/aim-resolve/steering/data/runs/files/exp_1062mhz"
)
