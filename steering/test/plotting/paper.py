...
plot_arrays([a, a, a, a, a, a], label=labels1, figsize=(5.2,5), cols=2, dpi=50, ticks=0, cbar=True, vmin=0, vmax=1)
...
plot_arrays([a, a, a, a], figsize=(5,5), cols=2, dpi=50, ticks=0, cbar=False, callback=callback, vmin=0, vmax=1)
...
plot_arrays([a, a, a, a, a, a], figsize=(5,5.1), cols=3, dpi=50, ticks=0, cbar=False, callback=callback, vmin=0, vmax=1)
...
plot_arrays([a, a, a, a], label=labels1, figsize=(5.3,5), cols=2, dpi=50, ticks=0, cbar=True, vmin=0, vmax=1)
...
labels1 = [
    'MCM: ESO137-006 galaxy mean', 'MCM: ESO137-006 galaxy relative standard deviation',
    'MCM: ESO137-007 galaxy mean', 'MCM: ESO137-007 galaxy relative standard deviation',
]

plot_arrays([a, b, a, b], label=labels1, figsize=(7,5), cols=1, dpi=100, ticks=0, cbar=True, vmin=0, vmax=1)
